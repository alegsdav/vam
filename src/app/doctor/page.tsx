...
export default function DoctorView() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex">
          ...
          <div className="flex items-center justify-between px-4 py-2 border-b border-white/10">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded bg-orange-500 flex items-center justify-center font-bold text-sm">E</div>
            ...
            <div className="flex items-center gap-4 text-sm">
              ...
              <span className="text-white/70">Internal Medicine</span>
            </div>
          </div>
          
          {/* Patient Banner */}
          <div className="px-4 py-3 flex items-center gap-6 bg-[#234876]">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3">
                ...
                <Badge className="bg-yellow-500/20 text-yellow-200 border-yellow-500/30">Inpatient</Badge>
              </div>
            ...
            {["Chart Review", "Notes", "Orders", "Results", "Medications", "Flowsheets"].map((tab, i) => (
              <button
                ...
                className={`px-4 py-2 rounded-t transition-colors ${
                  i === 0 ? "bg-slate-100 text-slate-900" : "text-white/70 hover:text-white hover:bg-white/10"
                }`}
              >
                {tab}
              </button>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-lg border shadow-sm p-4">
                <h3 className="font-semibold text-sm text-slate-500 uppercase tracking-wide mb-2">Chief Complaint</h3>
                <p className="text-slate-900">{patient.chiefComplaint}</p>
                <p className="text-sm text-slate-500 mt-2">Visit: {patient.recentVisit}</p>
              </div>

              {/* Vitals */}
              <div className="bg-white rounded-lg border shadow-sm p-4">
                <h3 className="font-semibold text-sm text-slate-500 uppercase tracking-wide mb-3">Vitals</h3>
              ...
              {/* Conditions */}
              <div className="bg-white rounded-lg border shadow-sm p-4">
                <h3 className="font-semibold text-sm text-slate-500 uppercase tracking-wide mb-3">Active Problems</h3>
            ...
            <div className="space-y-4">
              {/* Medications */}
              <div className="bg-white rounded-lg border shadow-sm p-4">
                <h3 className="font-semibold text-sm text-slate-500 uppercase tracking-wide mb-3">Current Medications</h3>
              ...
              {/* Recent Notes */}
              <div className="bg-white rounded-lg border shadow-sm p-4">
                <h3 className="font-semibold text-sm text-slate-500 uppercase tracking-wide mb-3">Recent Notes</h3>
                <div className="space-y-3">
                  <div className="p-3 bg-slate-50 rounded">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-xs font-medium text-slate-900">Progress Note</span>
                      <span className="text-xs text-slate-500">01/18/2026 14:32</span>
                    </div>
                  ...
                  <div className="p-3 bg-slate-50 rounded">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-xs font-medium text-slate-900">Nursing Assessment</span>
                      <span className="text-xs text-slate-500">01/18/2026 08:00</span>
                    </div>
                    <p className="text-sm text-slate-600 line-clamp-3">
            ...
            <div className="space-y-4">
              {/* Pending Orders */}
              <div className="bg-white rounded-lg border shadow-sm p-4">
                <h3 className="font-semibold text-sm text-slate-500 uppercase tracking-wide mb-3">Pending Orders</h3>
                <div className="space-y-2">
                  {[
              ...
              {/* Lab Results */}
              <div className="bg-white rounded-lg border shadow-sm p-4">
                <h3 className="font-semibold text-sm text-slate-500 uppercase tracking-wide mb-3">Recent Results</h3>
                <div className="space-y-2">
                  {[
      ...
      {/* AI Sidebar - The HealthBridge Widget */}
      <AnimatePresence>
        {showAIPanel && (
          <motion.aside
            ...
            className="bg-white border-l shadow-xl flex flex-col overflow-hidden"
          >
            {/* AI Panel Header */}
            <div className="p-4 bg-gradient-to-r from-accent to-emerald-500 text-white">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h2 className="font-semibold">HealthBridge AI</h2>
                    <p className="text-xs text-white/80">Real-time Clinical Intelligence</p>
                  </div>
                </div>
                <button 
            ...
            <div className="flex-1 overflow-auto p-4 space-y-4">
              <h3 className="text-sm font-semibold text-slate-900">AI Predictions</h3>
              ...
              {aiPredictions.map((prediction) => (
                ...
                >
                  ...
                  <p className="text-xs text-slate-500">{prediction.insight}</p>
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors cursor-pointer">
                      <div className="w-5 h-5 rounded-full border-2 border-accent flex items-center justify-center">
                        <CheckCircle2 className="w-3 h-3 text-accent opacity-0 hover:opacity-100" />
                      </div>
            ...
            <div className="p-4 border-t bg-slate-50">
              <p className="text-xs text-slate-500 text-center">
                Powered by HealthBridge • Last updated 2 min ago
              </p>
            </div>
          </motion.aside>
        )}

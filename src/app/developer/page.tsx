...
export default function DeveloperPage() {
    ...
    return (
        <div className="min-h-screen bg-background">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-6">
                            ...
                            <div className="hidden md:flex items-center gap-2 text-sm text-muted-foreground">
                                ...
                                <span className="font-medium text-foreground">Developer Documentation</span>
                            </div>
                        </div>
            ...
            {/* Main Content */}
            <main className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 py-8">
                {/* Back link */}
                <Link
                    href="/"
                            ...
                            <CardContent className="pt-0">
                                <nav className="space-y-1">
                                    {docSections.map((section, i) => (
                                        <button
                                            key={i}
                                            className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm transition-colors ${section.active
